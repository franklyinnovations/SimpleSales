          ...
          select: function( combo , record , eOpts ){
            ...
            if(pricestart!=null && pricestart != '' && pricestart.trim() !=''&& priceend!=null && priceend != '' && priceend.trim() !=''){
              if(Number(pricestart) > Number(priceend)){
                  Ext.getCmp('pro-type').setValue(record.data.Name + priceend + '-' + pricestart);
              }else{
                  Ext.getCmp('pro-type').setValue(record.data.Name + pricestart + '-' + priceend);
              }
        ...
        tbar:[
            ...
            },
            {
              ...
              handler:function(){
                ...
                var protypeName = Ext.getCmp('pro-type-cb').getSelection().data.Name;
                if(pricestart!=null && pricestart != '' && pricestart.trim() !=''&& priceend!=null && priceend != '' && priceend.trim() !=''){
                  if(Number(pricestart) > Number(priceend) && Number(pricestart) != 0 && Number(priceend) != 9999){
                      Ext.getCmp('pro-type').setValue(protypeName + priceend + '-' + pricestart);
                  }else{
                      Ext.getCmp('pro-type').setValue(protypeName + pricestart + '-' + priceend);
                  }

                }else{
                  Ext.getCmp('pro-type').setValue(protypeName)
                }
